  ...
  const rotateCircle = (index: number) => {
    ...
    gsap.to(circleRef.current, {
      ...
      onComplete: () => {
        ...
        gsap.to(pointRefs.current[index], { scale: 1.2, duration: 0.3 });
      },
    });
  };
    ...
    <section className={styles.wrapper}>
      <div className={styles.container}>
        ...
        <div className={styles.years}>
          <span className={styles.startYear}>{timePoints[activeIndex].startYear}</span>
          <span>&nbsp;&nbsp;</span>
          <span className={styles.endYear}>{timePoints[activeIndex].endYear}</span>
        </div>
